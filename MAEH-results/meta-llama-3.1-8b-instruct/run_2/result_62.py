...
def create_route_segment(
    ...
    # 根据突发事件，L1至A5之间的路径SEG-L1-A5不可通行
    if (start_location_id == "L1" and end_location_id == "A5") or (start_location_id == "A5" and end_location_id == "L1"):
