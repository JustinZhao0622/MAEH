...
def create_route_segment(
    ...
    # 根据突发事件，L2至A6之间的路径SEG-L2-A6不可通行
    if (start_location_id == "L2" and end_location_id == "A6") or (start_location_id == "A6" and end_location_id == "L2"):
