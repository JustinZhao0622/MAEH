...
def create_route_segment(
    ...
    # 根据突发事件，L1至B1之间的路径SEG-L1-B1不可通行
    if (start_location_id == "L1" and end_location_id == "B1") or (start_location_id == "B1" and end_location_id == "L1"):
