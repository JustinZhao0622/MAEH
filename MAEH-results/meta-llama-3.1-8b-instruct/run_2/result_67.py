...
def create_route_segment(
    ...
    # 根据突发事件，L2至B4之间的路径SEG-L2-B4不可通行
    if (start_location_id == "L2" and end_location_id == "B4") or (start_location_id == "B4" and end_location_id == "L2"):
