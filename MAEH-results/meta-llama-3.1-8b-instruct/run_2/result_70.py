...
def create_route_segment(
    ...
    # 根据突发事件，L1至B7之间的路径SEG-L1-B7不可通行
    if (start_location_id == "L1" and end_location_id == "B7") or (start_location_id == "B7" and end_location_id == "L1"):
