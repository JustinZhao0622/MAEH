...
def create_route_segment(
    ...
    # 根据突发事件，L2至C2之间的路径SEG-L2-C2不可通行
    if (start_location_id == "L2" and end_location_id == "C2") or (start_location_id == "C2" and end_location_id == "L2"):
