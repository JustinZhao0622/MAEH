...
def initialize_mobile_power_resources(
    ...
    # 检查是否存在故障的移动供电资源
    faulty_resource_id = "MOB-POWER-03"
    if faulty_resource_id in [r["resource_id"] for r in resources]:
        resources = [r for r in resources if r["resource_id"] != faulty_resource_id]
