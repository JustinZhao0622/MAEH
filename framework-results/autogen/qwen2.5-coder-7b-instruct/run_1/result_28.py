...
def adjust_hydraulic_resource_availability() -> None:
    """调整移动液压资源的可用性。
    ...
    作用：
        如果MOB-HYDRAULIC-01发生故障，则将其从可用资源列表中移除。
    """

    resources = initialize_mobile_hydraulic_resources(1, "L1")
    MOB_HYDRAULIC_01 = "MOB-HYDRAULIC-01"
    if MOB_HYDRAULIC_01 in [r["resource_id"] for r in resources]:
        resources = [r for r in resources if r["resource_id"] != MOB_HYDRAULIC_01]
