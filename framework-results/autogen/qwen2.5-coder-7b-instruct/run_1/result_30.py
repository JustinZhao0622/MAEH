...
def initialize_resources() -> dict[str, list[dict[str, Any]]]:
    """初始化所有资源。
    ...
    resources = {
        "供电": initialize_fixed_power_resources() + initialize_mobile_power_resources(1, "L1"),
        "液压": initialize_fixed_hydraulic_resources() + initialize_mobile_hydraulic_resources(0, "L1"),  # 移动液压资源故障，数量设为0
        "燃油": initialize_fixed_fuel_resources() + initialize_mobile_fuel_resources(1, "L1"),
        "供氧": initialize_fixed_oxygen_resources() + initialize_mobile_oxygen_resources(1, "L1"),
        # 其他资源类型可以类似初始化
    }
    return resources
