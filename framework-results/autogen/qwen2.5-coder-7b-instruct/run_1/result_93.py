...
def adjust_aircraft_assignment(
    ...
    fixed_power_resources: list[dict[str, Any]],
    fixed_hydraulic_resources: list[dict[str, Any]],
    fixed_fuel_resources: list[dict[str, Any]],
    fixed_oxygen_resources: list[dict[str, Any]],
    mobile_power_resources: list[dict[str, Any]],
    mobile_hydraulic_resources: list[dict[str, Any]],
    mobile_fuel_resources: list[dict[str, Any]],
    mobile_oxygen_resources: list[dict[str, Any]],
    tow_tractors: list[dict[str, Any]],
) -> dict[str, dict[str, Any]]:
    """调整舰载机的作业分配。
    ...
    for aircraft_id, aircraft_info in aircraft.items():
        if aircraft_info["location_id"] == "A6":
            # 移动A6站位的舰载机到其他可用站位
            for stand_id, stand_info in support_stands.items():
                if stand_id != "A6":
                    aircraft_info["location_id"] = stand_id
                    break
...
def main():
    ...
    aircraft = initialize_aircraft(aircraft_count, list(support_stands.keys()))
    aircraft = adjust_aircraft_assignment(
        aircraft,
        support_stands,
        fixed_power_resources,
        fixed_hydraulic_resources,
        fixed_fuel_resources,
        fixed_oxygen_resources,
        mobile_power_resources,
        mobile_hydraulic_resources,
        mobile_fuel_resources,
        mobile_oxygen_resources,
        tow_tractors,
    )
