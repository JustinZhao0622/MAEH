...
def adjust_support_stands(support_stands: dict[str, dict[str, Any]]) -> dict[str, dict[str, Any]]:
    ...
    if "B4" in support_stands:
        del support_stands["B4"]
...
def main():
    ...
    # 初始化舰载机
    aircraft_count = 10
    support_stand_ids = [stand_id for stand_id in support_stands if stand_id != "B4"]
    ...
    route_segments = [
        ...
        create_route_segment("A1", "R1"),
        create_route_segment("R1", "L2"),
        create_route_segment("L2", "C1"),
        create_route_segment("C1", "R2"),
        create_route_segment("R2", "L3"),
        create_route_segment("L3", "B1"),
        create_route_segment("B1", "R3"),
    ]
