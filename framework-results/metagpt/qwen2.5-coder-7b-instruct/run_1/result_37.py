def initialize_fixed_oxygen_resources(
    ...
    # 添加移动供氧资源
    if "MOB-OXYGEN-02" in [resource['resource_id'] for resource in resources]:
        resources.remove(next(resource for resource in resources if resource['resource_id'] == "MOB-OXYGEN-02"))
