def create_route_segment(
    ...
    if start_location_id == "L2" and end_location_id == "B4":
        raise ValueError("路径SEG-L2-B4因局部区域受限不可通行")
    ...
    return {
        ...
        "status": "不可通行" if start_location_id == "L2" and end_location_id == "B4" else "可通行",
        "blocked_reason": "局部区域受限" if start_location_id == "L2" and end_location_id == "B4" else None,
    }
