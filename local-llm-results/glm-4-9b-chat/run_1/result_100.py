...
def initialize_support_tasks() -> dict[str, dict[str, Any]]:
    ...
    return {
        ...
        if required_resource is not None or task_id != "T03" and task_id != "T05"
    }  # Filter out tasks that require resources B7 or C, which are not available due to the emergency.
