...
def initialize_fixed_power_resources(
    ...
    # Modify to account for the emergency situation in C zone
    if units_per_zone < 0:
                ...
                resources.append(
                    {
                        ...
                        "capacity": 0,  # Set capacity to 0 for the faulty resource
                        "available": False,  # Set availability to False for the faulty resource
                    }
                )
            else:
                resources.append(
