...
def initialize_runways() -> dict[str, dict[str, Any]]:
    # Modify the runway R3's zone to indicate the runway is not available due to the emergency
    return {
        runway_id: {
...
def initialize_fixed_power_resources(
    ...
    # Existing function body remains unchanged
    # ... (existing power resource initialization logic)

def initialize_fixed_hydraulic_resources(
    units_per_zone: int = 2,
) -> list[dict[str, Any]]:
    # Existing function body remains unchanged
    # ... (existing hydraulic resource initialization logic)

def initialize_fixed_fuel_resources(
    units_per_zone: int = 2,
) -> list[dict[str, Any]]:
    # Existing function body remains unchanged
    # ... (existing fuel resource initialization logic)

def initialize_fixed_oxygen_resources(
    units_per_zone: int = 2,
) -> list[dict[str, Any]]:
    # Existing function body remains unchanged
    # ... (existing oxygen resource initialization logic)
...
def initialize_mobile_power_resources(
    ...
    # Existing function body remains unchanged
    # ... (existing mobile power resource initialization logic)
...
def initialize_mobile_hydraulic_resources(
    ...
    # Existing function body remains unchanged
    # ... (existing mobile hydraulic resource initialization logic)
...
def initialize_mobile_fuel_resources(
    ...
    # Existing function body remains unchanged
    # ... (existing mobile fuel resource initialization logic)
...
def initialize_mobile_oxygen_resources(
    ...
    # Existing function body remains unchanged
    # ... (existing mobile oxygen resource initialization logic)
...
def initialize_tow_tractors(
    ...
    # Existing function body remains unchanged
    # ... (existing tow tractor initialization logic)
