...
def create_route_segment(
    ...
    # Modify the create_route_segment function to handle the emergency situation
    ...
    # Check if the segment is affected by the emergency situation
    if (start_location_id == "L1" and end_location_id == "B5") or (start_location_id == "B5" and end_location_id == "L1"):
        segment["status"] = "不可通行"
