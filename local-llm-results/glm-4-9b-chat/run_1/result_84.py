...
def initialize_aircraft(
    ...
    for index in range(1, aircraft_count + 1):
        ...
        # 修改此处，调整预计到达时间，根据突发事件描述，AC11计划于08:30到达，现延迟10分钟，预计于08:40到达
        if aircraft_id == "AC11":
            aircraft[aircraft_id] = {
                "aircraft_id": aircraft_id,
                "location_id": support_stand_ids[index - 1],
                "planned_arrival_time": float(planned_arrival_time + 10),  # 修改为08:40
                "actual_arrival_time": float(planned_arrival_time + 10),  # 修改为08:40
            }
        else:
            aircraft[aircraft_id] = {
                "aircraft_id": aircraft_id,
