...
def initialize_aircraft(
    ...
    delayed_departure_time: int,  # 新增加的参数
    ...
    for index in range(1, aircraft_count + 1):
        ...
        planned_arrival_time = (8 * 60 + 44) + index * 3  # 新调整的到达时间
...
aircraft_count = 14  # 舰载机数量
support_stand_ids = ["A1", "A2", "A3", "A4", "A5", "A6", "B1", "B2", "B3", "B4", "B5", "B6", "B7", "B8", "C1", "C2", "C3", "C4", "C5"]
delayed_departure_time = 11  # 延迟的起飞时间（分钟）

aircraft = initialize_aircraft(aircraft_count, support_stand_ids, delayed_departure_time)
print(aircraft)
