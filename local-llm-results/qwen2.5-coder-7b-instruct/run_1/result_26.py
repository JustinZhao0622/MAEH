...
if __name__ == "__main__":
    ...
    mobile_power_resources = initialize_mobile_power_resources(3, "A1")
    ...
    # 分配移动供电资源给牵引车
    mobile_power_resources = assign_power_resource_to_tow_tractor("MOB-TOW-01", "MOB-POWER-03", mobile_power_resources)
