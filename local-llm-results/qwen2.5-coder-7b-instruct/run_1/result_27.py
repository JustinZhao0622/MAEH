...
if __name__ == "__main__":
    ...
    mobile_power_resources = initialize_mobile_power_resources(1, "MOB-POWER-04")

    # 分配移动供电资源给牵引车
    tow_tractors = initialize_tow_tractors(1, "MOB-POWER-04")
    for tow_tractor in tow_tractors:
        mobile_power_resources = assign_power_resource_to_tow_tractor(tow_tractor["resource_id"], "MOB-POWER-04", mobile_power_resources)
