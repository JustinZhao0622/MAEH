...
def adjust_resource_availability() -> None:
    """调整资源可用性，移除故障的供氧资源FIX-A-OXYGEN-02。
    ...
    # 移除故障的供氧资源FIX-A-OXYGEN-02
    fixed_oxygen_resources = initialize_fixed_oxygen_resources()
    fixed_oxygen_resources = [res for res in fixed_oxygen_resources if res["resource_id"] != "FIX-A-OXYGEN-02"]
    initialize_fixed_oxygen_resources = lambda: fixed_oxygen_resources


# 在调度过程中调用adjust_resource_availability函数
# adjust_resource_availability()
