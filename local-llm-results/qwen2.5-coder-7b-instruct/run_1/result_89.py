...
def initialize_schedule() -> dict[str, Any]:
    """初始化调度计划。
    ...
    schedule: dict[str, Any] = {
        "support_stands": update_support_stands(),
        "aircraft": initialize_aircraft(10, ["A1", "A2", "A3", "A4", "A5", "A6", "B1", "B2", "B3", "B4", "B5", "B6", "B7", "B8", "C1", "C2", "C3", "C4", "C5"]),
        "resources": {
            "power": initialize_fixed_power_resources() + initialize_mobile_power_resources(5, "L1"),
            "hydraulic": initialize_fixed_hydraulic_resources() + initialize_mobile_hydraulic_resources(5, "L1"),
            "fuel": initialize_fixed_fuel_resources() + initialize_mobile_fuel_resources(5, "L1"),
            "oxygen": initialize_fixed_oxygen_resources() + initialize_mobile_oxygen_resources(5, "L1"),
        },
        "runways": initialize_runways(),
        "points": initialize_landing_points(),
    }
    return schedule
