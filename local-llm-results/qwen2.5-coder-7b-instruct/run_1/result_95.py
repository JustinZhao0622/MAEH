...
def update_support_stands() -> dict[str, dict[str, Any]]:
    """更新保障站位状态，将站位B2标记为不可用。
...
def initialize_system() -> dict[str, Any]:
    ...
    supports = update_support_stands()
    runways = initialize_runways()
    aircraft = initialize_aircraft(10, ["A1", "A2", "A3", "A4", "A5", "A6", "B1", "B3", "B4", "B5", "C1", "C2", "C3", "C4", "C5"])
    ...
    return {
        ...
        "hydraulic_resources": hydraulic_resources,
        "fuel_resources": fuel_resources,
        "oxygen_resources": oxygen_resources,
        "tow_tractors": tow_tractors,
    }
